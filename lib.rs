...
mod erc20 {
    ...
    impl Erc20 {
        #[ink(constructor)]
        pub fn new(initial_spply: Balance, name: ink_prelude::string::String, symbol: ink_prelude::string::String) -> Self {
            let caller = Self::env().caller();
            let mut balances = ink_storage::collections::HashMap::new();
            balances.insert(Self::env().caller(), initial_spply);
        ...
        #[ink(message)]
        pub fn set_metadata(&mut self, name: ink_prelude::string::String, symbol: ink_prelude::string::String) {
            self.symbol = symbol;
            self.name = name;
        }
    ...
    mod tests {
        ...
        #[ink::test]
        fn new_works() {
            let contract = Erc20::new(777, String::from("Hoang"), String::from("HOA"));
            assert_eq!(contract.total_supply(), 777);
            assert_eq!(contract.name(), String::from("Hoang"));
            assert_eq!(contract.symbol(), String::from("HOA"));
        }

        #[ink::test]
        fn balance_works() {
            let contract = Erc20::new(100, String::from("Hoang"), String::from("HOA"));
        ...
        #[ink::test]
        fn transfer_works() {
            let mut contract = Erc20::new(100, String::from("Hoang"), String::from("HOA"));
			assert_eq!(contract.balance_of(AccountId::from([0x1; 32])), 100);
